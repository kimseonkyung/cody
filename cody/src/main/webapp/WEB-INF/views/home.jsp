...
<html lang="en">
  <head>
	...
	<!-- CODY CSS -->
	<link href="${pageContext.request.contextPath}/resources/css/cody.css" rel="stylesheet">

    <!-- Bootstrap core CSS -->
    <link href="${pageContext.request.contextPath}/resources/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="${pageContext.request.contextPath}/resources/bootstrap/offcanvas.css" rel="stylesheet">
  ...
  <body class="bg-light">
	...
	<div id="main_section">
      <div class="my-3 p-3 bg-white rounded box-shadow">
        ...
        <li class="card" style="width: 240px; float: left;">
  			<img class="card-img-top" src="${pageContext.request.contextPath}/uploadfile/itemphoto/1_sss.jpg" alt="Card image cap" style="height: 300px;">
 			 <div class="card-body" style="overflow: hidden; position: relative;">
  			  <h5 class="card-title" style="float: left;">임해군</h5>
  			  <a href="#" class="btn btn-primary" style="position: absolute; right: 20px;">팔로우</a>
			</div>
   			     </li>
...
<a href="codyList">코디리스트</a><br>
<a href="listView?cody_idx=3">코디 상세보기</a><br>
<a href="listSearch?cody_title=샤랄라">코디 검색</a><br>
...
<a href="bookmarklist">즐겨찾기</a>
    ...
    <script>window.jQuery || document.write('<script src="${pageContext.request.contextPath}/resources/bootstrap/assets/vendor/jquery-slim.min.js"><\/script>')</script>
    <script src="${pageContext.request.contextPath}/resources/bootstrap/assets/vendor/popper.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/bootstrap/assets/vendor/holder.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/bootstrap/offcanvas.js"></script>
  </body>
</html>
