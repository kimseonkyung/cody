   ...
   <div
	...
	<div class="container">
		<nav class="nav nav-underline">
			...
			<a class="nav-link col-4 mr-auto" href="${pageContext.request.contextPath}/codyTimeListWoman" style="font-size: 22px; font-weight: 600; background-color: #17a2b8; color: #fff;">Women</a>
		</nav>
	</div>
</div>
