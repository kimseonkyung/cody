...
$(document).on('click','#findpw',function(){
	...
	$.ajax({
        ...
        success:function(data){
        	var pwLists = data.member_pw;
        	var pwLength = pwLists.length
        	var pwfind = pwLists.substring(1, pwLength-1)
       	 		 $("#pwList").append("<h1>"+"회원님의 정보로 등록된 비밀번호는 : "+pwfind+" 입니다.</h1>")
        },
		...
		<div  class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 row justify-content-center my-5" >
		<h3 style="color: #888888"  class="text-center font-weight-light text-justify col-xl-12">까먹은 비밀번호를 찾아봅시다</h3>
		<br>
		<br>
		<br>
		<br>
