...
<div class="nav-scroller bg-white">
	<div class="container">
		<nav class="nav nav-underline">
			<a class="nav-link col-4 mr-auto" id="all" href="${pageContext.request.contextPath}/itemListShoe" style="font-size: 22px; font-weight: 600;">All</a> 
				...
				<li class="card card-item-li" style="display:inline-block; margin-bottom: 50px;">
					<img class="card-img-top card-item" src="${item.item_image}" alt="Card image cap" onclick="itemListView(${item.item_idx})">
						<div class="card-body" style="height: 100%;">
							...
							<button class="btn btn-info" style="float: right; margin-bottom: 20px;"
