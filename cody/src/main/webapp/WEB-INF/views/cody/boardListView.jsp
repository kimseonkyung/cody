...
<body>
	...
	<div class="inbox">
		<input type="hidden" name="man_idx" value=2>
			...
			<div class="huge-top">
				<input type="button" class="btn btn-normal pull-right" onclick="location.href='/boardList'" value="수정">
				<input type="submit" class="btn btn-normal btn-blue pull-right" id="insert" name="insert" value="삭제]">	
			</div>
	</div>
</div>
</body>
