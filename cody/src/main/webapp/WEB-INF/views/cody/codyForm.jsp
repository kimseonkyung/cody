		...
		<div class="container">
			<nav class="nav nav-underline">
				<a class="nav-link active" href="#">Dashboard</a> <a
					...
					class="badge badge-pill bg-light align-text-bottom">27</span></a> <a
					class="nav-link" href="#">all</a> <a class="nav-link" href="#">men</a>
...
<div class="my-3 p-3 bg-white rounded">
					<div id="item">
							<div class="dropdown">
								<button id="input_item" type="button" data-toggle="dropdown">+
									항목 추가</button>
								<ul class="dropdown-menu">
									<li><a>항목 추가</a></li>
									<li class="divider">
									<li><button data-role="button" data-toggle="modal"
											data-target="#ClosetModal">옷장에서 선택</button></li>
									<li><button data-role="button" data-toggle="modal"
											data-target="#SearchModal">상품 검색</button></li>
									<li><button type="button" data-toggle="modal"
											data-target="#NewitemModal">신규 아이템 등록</button></li>
									<li><button type="button" data-toggle="modal"
											data-target="#NaveritemModal">네이버 검색</button></li>
								</ul>
							</div>
							<div id="item_intro">
					...
					<div id="gender">
						...
						<div id="gender_input">
							<label><input type="radio" name="cody_gender"
								value="true">Man</label> <label> <input type="radio"
								name="cody_gender" value="false">Woman
							</label>
						</div>
					</div>
					</div>
  ...
  <tbody>
    ...
    <tr>
      <th scope="row"><a href="${naver_link}"><img
											src="${naver_image}" width="100px" height="100px"></a></th>
												...
												function(i, row) {
													var $tr = $('<tr>')
															.append(
																	...
																	$('<td>')
																			.html(
																					'<input type="checkbox" name="item_check" value="'+row.productId+'">'));
													$tr.appendTo($table);
												});
											...
											function(i, row) {
												...
												$tr = $('<tr>')
														.append(
																$('<td>')
																		.html(
																				'브랜드 : <input name="itemList['+idx+'].item_brand" type="text" >'));
												$tr.appendTo($div);
												$tr = $('<tr>')
														.append(
																$('<td>')
																		.html(
																				' 카테고리 : <select id="input_category" name="itemList['+idx+'].item_category">'
																						+ '<option>선택해주세요</option>'
																						+ '<option value="모자">모자</option>'
																						+ '<option value="상의">상의</option>'
																						+ '<option value="하의">하의</option>'
												...
												$tr = $('<tr>')
														.append(
																$('<td>')
																		.html(
																				' 색상 : <select id="input_color" name="itemList['+idx+'].item_color">'
																						+ '<option>선택해주세요</option>'
												...
												var $hidden = $('<div>')
														.html(
																'<input type="hidden" name="itemList['+idx+'].item_image" value="'+row.image+'">'
